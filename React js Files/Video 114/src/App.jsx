  ...
  return (
    ...
    <Navbar/> 
       <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-violet-100 min-h-[80vh] md:w-[35%]">
        <h1 className='font-bold text-center text-3xl'>Apka Resturent - Manage your Food at one place</h1>
         <div className="addTodo my-5 flex flex-col gap-4">
          <h2 className='text-2xl font-bold'>Add a Food</h2>
          <div className="flex">
         ...
         <h2 className='text-2xl font-bold'>Your Food Name</h2>
         <div className="todos">
          {todos.length ===0 && <div className='m-5'>No Food Name to display</div> }
          {todos.map(item=>{
